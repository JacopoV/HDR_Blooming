...
bool BlurShaderV::Initalize(ID3D11Device* pd3dDevice)
{
	...
	HRESULT hr = D3DX11CompileFromFile(L"Shaders/blur_v.fx", NULL, NULL,NULL, "fx_5_0", dwShaderFlags, 0,
		NULL, &pBlob, &pErrorBlob, NULL);


    if( FAILED( hr ) )
    {
		MessageBox(NULL, L"Problema nel caricamento di blur_v.fx.", L"Error", MB_OK );
	...
	m_Technique = m_Effect->GetTechniqueByName( "Blur_v" );
	...
	m_Effect->GetVariableByName("blurSizeV")->AsScalar()->SetFloat(blurSizeV);
