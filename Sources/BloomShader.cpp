#include "../Headers/BloomShader.h"


bool BloomShader::Initalize(ID3D11Device* pd3dDevice)
{
	...
	HRESULT hr = D3DX11CompileFromFile(L"Shaders/bloom.fx", NULL, NULL,NULL, "fx_5_0", dwShaderFlags, 0,
		NULL, &pBlob, &pErrorBlob, NULL);


    if( FAILED( hr ) )
    {
		MessageBox(NULL, L"Problema nel caricamento di bloom.fx.", L"Error", MB_OK );
	...
	m_Technique = m_Effect->GetTechniqueByName( "Bloom" );
...
void BloomShader::SetShaderTexturePhong(ID3D11ShaderResourceView* texture)
{
